...
def save_screenshot(config, window, data, output_folder):
    ...
    if data["id"].lower().endswith((".png", ".jpg", ".jpeg", ".bmp", ".gif")):
        ext=""
    else:
        ext=".png"
    screenshot_path = os.path.join(output_folder, data["id"] + ext)
